...
nmap <leader>fo :ClangFormat<CR>

"iabbr sout System.out.println("
"iabbr souf System.out.printf("
...
Plug 'HerringtonDarkholme/yats' "TS syntax 
...
autocmd vimEnter *.java map <F8> :w<CR> :!clear; /usr/lib/jvm/java-17/bin/javac %; time /usr/lib/jvm/java-17/bin/java %:r; rm *.class<CR>
